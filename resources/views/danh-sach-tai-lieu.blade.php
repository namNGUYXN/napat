...
@section('content')
    ...
    <div class="col bg-light p-4 overflow-auto custom-scrollbar">
        ...
        <div class="document-grid">
            @foreach ($dsMucBaiGiang as $muc)
                <div class="document-card rounded">
                    <a href="{{ route('muc-bai-giang.chi-tiet', ['id' => $muc->id]) }}" class="document-img">
                        <img src="https://picsum.photos/id/1/1000/600" class="img-fluid rounded-top" alt="">
                    </a>
                    <div class="p-3">
                        <a href="document-detail.html" class="text-dark document-name">{{ $muc->ten }}</a>
                        <p class="mb-1"><b>Số lượng bài giảng: </b>{{ $muc->bai_giangs_count }}</p>
                        <p class="mb-1"><b>Ngày tạo: </b> 04/06/2025</p>
                        <small class="text-secondary fst-italic">{{ $muc->mo_ta_ngan }}</small>
