                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('bai.update', $bai->id) }}" method="POST" id="form-chinh-sua-bai">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control tinymce" name="noi_dung" rows="10" required
                        ...
                        <form id="editExerciseForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="number" class="form-control" id="editExerciseMaxScore"
                            ...
                            <div id="editQuestionsFormContainer">
                                <h6>Danh sách câu hỏi:</h6>
                                <div class="text-center text-muted p-3" id="noEditQuestionsMessage"
                                    style="display: none;">
...
@section('scripts')
    ...
    <script src="https://cdn.tiny.cloud/1/po7o4s0ef6r58jtnxjdqrao0o46qm20hdq4juv4rej5zpolm/tinymce/7/tinymce.min.js"
