    ...
    <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="exercise-tab" data-bs-toggle="tab" data-bs-target="#exercise-pane" type="button"
          role="tab" aria-controls="exercise-pane" aria-selected="false">Bài tập của
          bài</button>
      </li>
    </ul>
            ...
            <form action="{{ route('bai.update', $bai->id) }}" method="POST" id="form-chinh-sua-bai">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tieu_de') is-invalid @enderror" name="tieu_de"
                  placeholder="Nhập tiêu đề bài..." required maxlength="255" id="lecture-title"
                  value="{{ $bai->tieu_de }}">
            ...
            <div class="modal-body">
              <form id="newExerciseForm">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-3 col-lg-2 mt-3 mt-sm-0"> <label for="newExerciseMaxScore" class="form-label">Điểm
                      tối
                      đa</label>
