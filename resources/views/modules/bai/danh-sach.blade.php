                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" class="mb-3">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search"
                                    value="{{ request()->input('search') }}" placeholder="Tìm bài..." autocomplete="off">
                        ...
                        <form action="{{ route('bai.quick-delete') }}" method="POST">
                            ...
                            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4" id="list-bai">
                                @forelse ($listBai as $bai)
                                    <div class="col draggable-item" data-id="{{ $bai->id }}">
                                        <div class="card text-center shadow-sm h-100 position-relative">
                                            ...
                                            <input type="checkbox"
                                                class="form-check-input position-absolute m-2 row-checkbox"
                                                name="list_id_bai[]" value="{{ $bai->id }}"
                                ...
                                @empty
                                    <div class="col text-center text-muted">Không có bài nào</div>
                                @endforelse
                            </div>
