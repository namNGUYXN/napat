...
@section('content')
    <div class="col bg-light p-4 overflow-auto custom-scrollbar">
        ...
        <a href="/tai-lieu" class="btn btn-outline-secondary mb-4">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body" id="courseDetailContent">
                        <h4 id="courseTitle">{{ $muc->ten }}</h4>
                        <p><strong>Mô tả:</strong> <span id="courseDescription">{{ $muc->mo_ta_ngan }}</span></p>
                        <p><strong>Số lượng bài giảng:</strong> <span id="lessonCount">{{ $muc->so_luong_bai_giang }}</span>
                            bài</p>
                        <p><strong>Ngày tạo:</strong> <span id="courseCreationDate">2023-01-01</span></p>
                        <hr>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="lecture-create.html" class="btn btn-light btn-sm">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody id="lessonListBody">
                                    @foreach ($muc->baiGiangs as $baiGiang)
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>{{ $baiGiang->tieu_de }}</td>
                                            <td>2023-01-15</td>
                                            <td class="text-center">
                                                <button class="btn btn-info btn-sm me-1 view-lesson-detail-btn"
                                                    data-bs-toggle="modal" data-bs-target="#lessonDetailModal"
                                                    data-lesson-id="1">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <a href="{{ route('bai-giang.chinh-sua', ['id' => $baiGiang->id]) }}"
                                                    class="btn btn-warning btn-sm me-1 edit-lesson-btn">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button class="btn btn-danger btn-sm delete-lesson-btn" data-lesson-id="1">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="lessonDetailModalLabel">Chi tiết bài giảng: <span
                            id="modalLessonTitle"></span></h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body" id="modalLessonContent">
                    <p><strong>ID Bài giảng:</strong> <span id="detailId"></span></p>
                    <p><strong>Tên bài giảng:</strong> <span id="detailTitle"></span></p>
