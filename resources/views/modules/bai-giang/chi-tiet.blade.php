                        ...
                        <form action="{{ route('chuong.quick-delete') }}" method="POST">
                            ...
                            <div id="list-chuong" class="d-flex flex-column gap-2">
                                @forelse ($listChuong as $chuong)
                                    <div class="p-3 bg-light border rounded shadow-sm folder-item"
                                        data-id="{{ $chuong->id }}" style="cursor: grab;" draggable="true">

                                        <!-- Phần trên: icon + text -->
                                        <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
                                            <!-- Bên trái -->
                                            <div class="d-flex align-items-start gap-2">
                                                <input type="checkbox" class="form-check-input row-checkbox mt-1"
                                                    name="list_id_chuong[]" value="{{ $chuong->id }}">
                                                <i class="fas fa-folder fa-lg text-warning mt-1"></i>

                                                <div class="text-wrap">
                                                    <a href="{{ route('bai.index', $chuong->id) }}"
                                                        class="folder-title text-decoration-none link-dark">
                                                        {{ $chuong->tieu_de }}
                                                    </a>
                                            ...
                                            <div
                                                ...
                                                <a href="{{ route('bai.index', $chuong->id) }}" class="btn btn-info btn-sm"
                                                    title="Xem">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <button type="button" class="btn btn-warning btn-sm btn-update-chuong"
                                                    title="Sửa"
