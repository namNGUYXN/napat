        ...
        <div class="tab-content" id="classTabContent">
            ...
            <div class="tab-pane fade show active" id="news" role="tabpanel">
                ...
                <div class="card mb-4">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('storage/' . $lop->hinh_anh) }}" class="img-fluid rounded-start"
                                alt="">
                        </div>
                ...
                @if (session('vai_tro') == 'Giảng viên')
                    <button type="button" class="newsletter-add-btn btn btn-primary rounded-circle"
                        title="Tạo bản tin mới" data-bs-toggle="modal" data-bs-target="#newNewsletterModal">
                        ...
                        <div class="accordion" id="accordion-chuong">
                                                                    ...
                                                                    <th scope="col">
                                                                        <div class="form-check form-switch"
                                                                            ...
                                                                            <input class="form-check-input check-all"
                                                                                ...
                                                                                data-bs-title="Công khai bài học"
                            ...
                            @if (session('id_nguoi_dung') == $lop->id_giang_vien)
                                <button type="button" class="btn btn-success mt-3 btn-public-bai"
                                    data-bs-toggle="tooltip" data-bs-title="Cập nhật trạng thái công khai cho các bài học"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="newExerciseForm">
                                        <div class="row mb-3">
                                            <div class="col-sm-9 col-lg-10">
                                                ...
                                                <input type="text" class="form-control" name="tieu_de"
                                                    id="newExerciseTitle" placeholder="Nhập tiêu đề bài tập" required>
                                            ...
                                            <div class="col-sm-3 col-lg-2 mt-3 mt-sm-0"> <label for="newExerciseMaxScore"
                                                    ...
                                                    đa</label>
                                                <input type="number" class="form-control" name="diem_toi_da"
                                        ...
                                        <div id="questionsFormContainer">
                                            ...
                                            <div class="question-item mb-4 p-3 border rounded bg-light">
                                                ...
                                                <div class="row g-2 mb-3">
                                                    <label class="form-label">Đáp án: <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-text">
                                                                <input class="form-check-input mt-0 correct-answer-radio"
                                                                    type="radio" name="correctAnswer_1" value="optionA"
                                                                    aria-label="Đáp án A" required>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-text">
                                                                <input class="form-check-input mt-0 correct-answer-radio"
                                                                    type="radio" name="correctAnswer_1" value="optionB"
                                                                    aria-label="Đáp án B" required>
                                                            </div>
                                                            <input type="text" class="form-control answer-option"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-text">
                                                                <input class="form-check-input mt-0 correct-answer-radio"
                                                                    type="radio" name="correctAnswer_1" value="optionC"
                                                                    aria-label="Đáp án C" required>
                                                            </div>
                                                            <input type="text" class="form-control answer-option"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <div class="input-group-text">
                                                                <input class="form-check-input mt-0 correct-answer-radio"
                                                                    type="radio" name="correctAnswer_1" value="optionD"
                                                                    aria-label="Đáp án D" required>
                                                            </div>
                                                            <input type="text" class="form-control answer-option"
                                        ...
                                        <div class="text-center text-muted mb-3" id="noQuestionsMessage"
                                            style="display: none;">
